...
////@begin includes
////@end includes
#include "windowBaseImpl/wxGuiWinBaseExports.h"
...
class WXDLLIMPEXP_GUIWINBASE wxGuiPluginWindowBase: public wxPanel
{    
    wxDECLARE_DYNAMIC_CLASS( wxGuiPluginWindowBase );
