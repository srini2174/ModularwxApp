...
////@begin wxModularHostApp member function declarations
	...
	ReferencePluginManager * GetPluginManager() const { return m_PluginManager ; }
	void SetPluginManager(ReferencePluginManager * value) { m_PluginManager = value ; }

////@end wxModularHostApp member function declarations

////@begin wxModularHostApp member variables
	ReferencePluginManager * m_PluginManager;
