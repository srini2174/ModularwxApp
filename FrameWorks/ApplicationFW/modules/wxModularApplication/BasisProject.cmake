...
basis_project (
  # --------------------------------------------------------------------------
  # meta-data
  NAME             "ModularApplication"
  VERSION          "1.0.0"
  AUTHORS          #<author>
  DESCRIPTION      "Main Application written in wxWidgets"
  ...
  CONTACT          "<provider-name> <module-a@<vendor>.com>"
  TEMPLATE         "basis/1.4"
  ...
  DEPENDS
    #<dependency>
    ApplicationFW{ApplicationCore}
    PluginItf{wxGuiPluginItf}
  OPTIONAL_DEPENDS
    #<optional-dependency>
  TEST_DEPENDS
    #<test-dependency>
